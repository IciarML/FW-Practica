...
addPost({imagen: "Photos/Image1.jpg", titulo: "HARRY POTTER COLECCIÓN COMPLETA", autor: "J.K. Rowling", precio: "80.68",
        genero: "Fantasía", sinopsis: "...", isbn: "9788408224228", editorial:"...", idioma: "Castellano", optionRadios: "Tapa blanda"}); 
addPost({imagen: "Photos/Image2.jpg", titulo: "THE BELL JAR", autor: "Sylvia Plath", precio: "11.18",
...
addPost({imagen: "public/Photos/Image5.jpg", titulo: "HEARTSTOPPER 1. DOS CHICOS JUNTOS", autor: "Alice Oseman", precio: "15.15",
        ...
        isbn: "9788408224228", editorial:"...", idioma: "Castellano", optionRadios: "Tapa blanda"}); 
...
addPost({imagen: "../Photos/Image10.jpg", titulo: "EIGHTEEN", autor: "Alberto Ramos", precio: "12.25",
        genero: "Poesía", sinopsis: "...", isbn: "9788408224228", editorial:"...", idioma: "Castellano", optionRadios: "Tapa blanda"}); 
addPost({imagen: "../Photos/Image11.jpg", titulo: "VEINTE MIL LEGUAS DE VIAJE SUBMARINO", autor: "Julio Verne", precio: "14.96",
        genero: "Aventura", sinopsis: "...", isbn: "9788408224228", editorial:"...", idioma: "Castellano", optionRadios: "Tapa blanda"}); 
addPost({imagen: "../Photos/Image12.jpg", titulo: "LOS PACIENTES DEL DOCTOR GARCÍA", autor: "Almudena Grandes", precio: "21.75",
